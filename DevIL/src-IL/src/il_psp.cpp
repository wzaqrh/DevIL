...
IL_TLVAR ILubyte PSPSignature[32] = {
...
IL_TLVAR ILubyte GenAttHead[4] = {
	0x7E, 0x42, 0x4B, 0x00
};


// Make these global, since they contain most of the image information.
IL_TLVAR GENATT_CHUNK	AttChunk;
IL_TLVAR PSPHEAD			Header;
IL_TLVAR ILuint			NumChannels;
IL_TLVAR ILubyte			**Channels = NULL;
IL_TLVAR ILubyte			*Alpha = NULL;
IL_TLVAR ILpal			Pal;
