...
IL_TLVAR ILconst_string _ilVendor		= IL_TEXT("Abysmal Software");
IL_TLVAR ILconst_string _ilVersion		= IL_TEXT("Developer's Image Library (DevIL) 1.8.0");


IL_TLVAR char* _ilLoadExt		= (char*)"" IL_BLP_EXT IL_BMP_EXT IL_CUT_EXT IL_DCX_EXT IL_DDS_EXT
...
IL_TLVAR char* _ilSaveExt		= (char*)"" IL_BMP_EXT IL_CHEAD_EXT IL_DDS_EXT IL_EXR_EXT
